export const hoteisParceiros = {
  Seoul: [
    {
      place_id: "seoul-1",
      name: "Four Seasons Hotel Seoul",
      rating: 5,
      formatted_address: "97 Saemunan-ro, Jongno-gu, Seul",
    ...
    },
    {
      ...
      rating: 4,
      formatted_address: "137 Toegye-ro, Jung-gu, Seul",
  ...
  Busan: [
    {
      ...
      name: "Signiel Busan",
      rating: 5,
      formatted_address: "30 Haeundaehaebyeon-ro, Haeundae-gu, Busan",
  ...
  Jeju: [
    {
      ...
      rating: 5,
      formatted_address: "75 Seogwipo-si, Jeju-do",
