...
function App() {
  ...
  const enviarWhatsApp = () => {
    ...
    const dataInicio =
      state[0].startDate.toLocaleDateString('pt-BR');

    const dataFim =
      state[0].endDate.toLocaleDateString('pt-BR');

    const mensagem =
      `Olá! Tenho interesse no pacote *${pacoteAtivo.nome}*.\n\n` +
        ...
        {pacoteAtivo && (
          ...
          <div className="modal_overlay">
            ...
            <div className="modal_content">
              ...
              <button
                onClick={() => setPacoteAtivo(null)}
                className="btn_fechar"
              >
                ✕
              </button>
