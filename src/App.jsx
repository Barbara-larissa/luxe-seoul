...
function App() {
  ...
  // Criamos estados para adultos e crianças para o React controlar os valores
...
const enviarWhatsApp = () => {
  ...
  const mensagem = `Olá! Tenho interesse no pacote *${pacoteAtivo.nome}*.\n\n` +
                   `📅 Período pretendido: ${dataInicio} até ${dataFim}\n` +
                   `👥 Adultos: ${adultos}\n` +
                   `👶 Crianças: ${criancas}\n\n` +
                   `*Poderia me confirmar o valor total ?*`; // O cliente pergunta o preço final
            ...
            <div className="modal_content">
              ...
              <div className="calendar_container">
                <DateRange
                  ...
                  ranges={state}
                  locale={ptBR}
                  rangeColors={['#EF007E']} // Mudei para Rosa Magenta!
                />
              </div>
              ...
              <div className="modal_footer">
                ...
                <button className="btn_confirmar" onClick={enviarWhatsApp}>
